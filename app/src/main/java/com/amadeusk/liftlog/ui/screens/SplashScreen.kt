...
// Jagged, real-user-style progress: overall up but with dips, plateaus, and uneven steps
private val SPLASH_GRAPH_VALUES = listOf(
    20.0, 22.0, 20.0, 25.0, 28.0, 26.0, 30.0, 35.0, 38.0, 38.0, 42.0, 40.0, 48.0, 55.0, 52.0,
    58.0, 62.0, 65.0, 63.0, 70.0, 75.0, 78.0, 82.0, 80.0, 88.0, 92.0, 95.0, 90.0, 98.0, 105.0, 108.0
)
        ...
        Column(
            ...
            Box(
                ...
                Canvas(modifier = Modifier.fillMaxSize()) {
                    ...
                    val values = SPLASH_GRAPH_VALUES
